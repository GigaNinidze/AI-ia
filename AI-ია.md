...
*(აქ კამათელი უნდა დავაგენერირო 33 ასოთი)*
დავითვალოთ საშუალოდ რამდენი სიტყვა "
ეს მეთოდი დაგევხმარებოდა რომ ქართული ენის მსგავსი ჟღერადობის სიტყვები შევქმნათ, ზოგჯერ 
...
ახლა ამ ტექსტის შესაბამისი ტოკენები უნდა ვიპოვოთ. ამისათვის გამოვიყენებთ SentencePiece.ის არ ეყრდნობა ხელით დაწერილ წესებს, სწავლობს თვითონ სტატისტიკურად.
